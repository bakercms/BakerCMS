...
/* Upgrade Step 1 */
$lang["upgrade_title"] = "Baker CMS Upgrade";

$lang["upgrade_step1"] = "Step 1/3: Checking your existing setup";
$lang["upgrade_step1_details"] = "To upgrade Baker CMS to version " . $h->version . ", click 'Next'...";
$lang["upgrade_step1_old_version"] = "You are currently running Baker CMS version ";
$lang["upgrade_step1_old_no_version"] = "We could not find an existing version number of Baker CMSS in your database.";
$lang["upgrade_step1_current_version"] = "You already have the latest version of Baker CMS installed.<br/><br/>If you want to run the upgrade script again click 'Next', otherwise you can close this browser window now.";

/* Upgrade Step 2 */
$lang["upgrade_step2"] = "Step 2/3: Upgrade Complete";
$lang["upgrade_step2_details"] = "Congratulations! You have successfully upgraded Baker CMS.";

/* Upgrade Step 2 */
$lang["upgrade_step3"] = "Step 3/3: Check Plugins, Templates";
$lang["upgrade_step3_details"] = "You have successfully upgraded Baker CMS.";
$lang["upgrade_step3_instructions"] = "After clicking \"Finish\" you may find some of your plugins need upgrading. You can check the latest version numbers from the Plugin Management page in your admin dashboard. You may also need to modify any templates you have customised to make sure they work with the latest version of Baker CMS.";
$lang["upgrade_step3_go_play"] = "Click \"Finish\" to access your Baker CMS site!";
$lang["upgrade_home"] = "Finish";

/* Install Common */
$lang["install_title"] = "Baker CMS Setup";
$lang["install_next"] = "Next";
$lang["install_back"] = "Back";
$lang["install_trouble"] = "Having trouble? Read the <a href='http://bakercms.com/codex-docs/'>Documentation</a> or ask for help in the <a href='http://bakercms.com/forum/index.php'>Forums</a>.";

/* Install Step 1 */
$lang["install_step0"] = "Welcome to Baker CMS";
$lang["install_step0_welcome"] = "Installing Baker CMS can be completed in just 4 steps and normally requires just a few minutes.";
$lang["install_step0_select"] = "Select below whether you want to make a new installation or upgrade an existing Baker CMS site...";
$lang["install_new"] = "New Installation";
$lang["install_upgrade"] = "Upgrade Existing Site";

/* Install Step 2 */
$lang["install_step1"] = "Step 1/4: Database Setup";
$lang["install_step1_instructions"] = "To set up a database for Baker CMS, you'll need to do the following";
$lang["install_step1_instructions1"] = "Create a database called <i>bakercms</i> in your web host's control panel. Make a note of your username and password!";
$lang["install_step1_instructions2"] = "Copy <pre>/bakercms_settings_default.php</pre> and rename it <pre>/bakercms_settings.php</pre>.";
$lang["install_step1_instructions3"] = "Open <pre>/bakercms_settings.php</pre> and fill in the \"Database Details\" section.";
$lang["install_step1_instructions4"] = "Fill in the <pre>baseurl</pre>, e.g. <i>http://example.com/</i>. Don't forget the trailing slash (/)";
$lang["install_step1_instructions5"] = "Save and upload <pre>bakercms_settings.php</pre> to your server, then click \"Next\"...";
...
$lang["install_step1_dbprefix_explain"] = "Database prefix, e.g. 'bakercms_'";
...
$lang["install_step1_settings_file_already_exists"] = "There is already a Baker CMS settings file on your server. If you press 'update' your existing file will be updated with the settings above.";
$lang["install_step1_settings_db_already_exists"] = "There is already a Baker CMS database on your server with live tables. If you press 'Next' your entire database will be wiped clean. Proceed with caution.";
$lang["install_step1_update_file_writing_success"] = "The 'bakercms_settings' file was created.";
$lang["install_step1_update_file_writing_failure"] = "There was a problem creating the 'bakercms_settings' file.";
...
$lang["install_step2_already_exists"] = "It seems there are already tables for Baker CMS in the database.";
...
$lang["install_step2_success"] = "Database tables created successfully. Click \"Next\" to configureBaker CMS.";
...
$lang["install_step2_existing_db"] = "You already have an existing installation of Baker CMS.<br/><br/>If you continue, this installation will DELETE all your existing tables and settings, including posts, users and plugin data.";
...
$lang["install_step4_form_check_php_version"] = "Baker CMS has not been tested on this version of PHP. You may need to upgrade";


$lang["install_step4_installation_go_play"] = "Done? Okay, go and play with your new Baker CMS site!";
