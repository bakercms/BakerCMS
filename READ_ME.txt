...
Please visit http://bakercms.com/codex-item/installing-and-upgrading/ for
...
BakerCMS has been tested using PHP 5.2.5 ~ 5.3.2 and MySQL 5.0~.
...
-----------------------
 ...
 3. Rename `/bakercms_settings_default.php` to `/bakercms_settings.php`.
 4. Open `/bakercms_settings.php` and edit the top section with your database
...
much detail as possible in the forums at http://bakercms.com. Thanks.